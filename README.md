...
**Edge Intelligence Theme** — 参考 [Cloudflare-Showcase](https://github.com/ymh0000123/Cloudflare-Showcase) 页面风格制作的 DSH（DeepSeek Harness）Web 主题插件（动态 Cordis 插件，Client 半部）。

## 设计语言

还原参考页「Cloudflare 边缘智能」编辑风：
